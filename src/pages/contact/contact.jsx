          ...
          {isSubmitted ? (
            <div className="text-center py-12 sm:py-16">
              ...
              <button
                ...
                className="bg-black text-white py-3 sm:py-4 px-6 sm:px-8 font-light uppercase tracking-wider hover:bg-text-dark transition-colors text-sm sm:text-base"
              >
            ...
            <>
              ...
              <form onSubmit={handleSubmit} className="space-y-6 sm:space-y-8">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6 sm:gap-8">
                  <div>
                    <label className="block text-sm font-light text-black uppercase tracking-wide mb-2 sm:mb-3">
                      Full Name *
                    </label>
                    <input
                      type="text"
                ...
                <div className="flex flex-col sm:flex-row gap-4 sm:gap-6 pt-2 sm:pt-4">
                  <button
                    ...
                    className="flex-1 bg-black text-white py-3 sm:py-4 px-6 sm:px-8 font-light hover:bg-text-dark transition-colors uppercase tracking-wider text-sm sm:text-base flex items-center justify-center gap-3 disabled:bg-text-light disabled:cursor-not-allowed"
                  >
                    {isSubmitting ? (
                      <>
                  ...
                  <button
                    ...
                    className="flex-1 bg-black text-white font-light uppercase tracking-wider hover:bg-text-dark transition-colors flex items-center justify-center gap-3 text-sm sm:text-base py-3 sm:py-4 px-6 sm:px-8"
                  >
