    ...
    <div className="min-h-screen bg-premium-cream lg:pt-6 md:pt-6 font-futura-pt-light">
      ...
      <section className="relative py-2 bg-gradient-to-br from-premium-beige via-premium-cream to-premium-warm-white overflow-hidden">
        ...
        <div className="relative z-10 max-w-6xl mx-auto px-6 text-center">
          ...
          <p className="text-black text-sm md:text-base font-light leading-relaxed font-futura-pt-light max-w-2xl mx-auto">
        ...
        <div className="bg-white p-6 sm:p-12 shadow-xl border border-text-light/10 relative">
          ...
          {isSubmitted ? (
            <div className="text-center py-12 sm:py-16">
              ...
              <h2 className="text-base md:text-lg font-light text-black mb-4 sm:mb-6 font-futura-pt-book">
                Message Sent Successfully!
              </h2>
              <p className="text-black text-sm md:text-base mb-6 sm:mb-8 max-w-md mx-auto px-4 font-light font-futura-pt-light">
                Thank you for reaching out. We'll get back to you within 24 hours.
              </p>
              <button
                onClick={() => setIsSubmitted(false)}
                className="bg-black text-white py-3 sm:py-4 px-6 sm:px-8 font-light hover:bg-gray-900 transition-colors text-sm sm:text-base font-futura-pt-light"
              >
            ...
            <>
              <div className="mb-8 sm:mb-12">
                <h2 className="text-base md:text-lg font-light text-black mb-3 sm:mb-4 font-futura-pt-book">
                  Send Us a Message
                </h2>
                <p className="text-black font-light text-sm md:text-base leading-relaxed max-w-2xl font-futura-pt-light">
              ...
              <form onSubmit={handleSubmit} className="space-y-6 sm:space-y-8">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6 sm:gap-8">
                  <div>
                    <label className="block text-sm font-light text-black mb-2 sm:mb-3 font-futura-pt-book">
                      Full Name *
                    </label>
                    <input
                      type="text"
                      ...
                      className={`w-full px-4 py-3 sm:py-4 border-2 focus:outline-none text-sm sm:text-base transition-colors font-light font-futura-pt-light text-black ${formErrors.name
                  ...
                  <div>
                    ...
                    <input
                      ...
                      onChange={handleInputChange}
                      className={`w-full px-4 py-3 sm:py-4 border-2 focus:outline-none text-sm sm:text-base transition-colors font-light font-futura-pt-light text-black ${formErrors.email
                        ? 'border-red-500 bg-red-50'
                        : 'border-gray-300 focus:border-luxury-gold hover:border-gray-400'
                        }`}
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6 sm:gap-8">
                  <div>
                    ...
                    <input
                      ...
                      onChange={handleInputChange}
                      className="w-full px-4 py-3 sm:py-4 border-2 border-gray-300 focus:border-luxury-gold hover:border-gray-400 focus:outline-none text-sm sm:text-base transition-colors font-light font-futura-pt-light text-black"
                  ...
                  <div>
                    ...
                    <select
                      ...
                      onChange={handleInputChange}
                      className={`w-full px-4 py-3 sm:py-4 border-2 focus:outline-none text-sm sm:text-base transition-colors font-light font-futura-pt-light text-black ${formErrors.subject
                        ? 'border-red-500 bg-red-50'
                        : 'border-gray-300 focus:border-luxury-gold hover:border-gray-400'
                        }`}
                    >
                ...
                <div>
                  ...
                  <textarea
                    ...
                    onChange={handleInputChange}
                    rows={6}
                    className={`w-full px-4 py-3 sm:py-4 border-2 focus:outline-none text-sm sm:text-base transition-colors resize-none font-light font-futura-pt-light text-black ${formErrors.message
                      ? 'border-red-500 bg-red-50'
                      : 'border-gray-300 focus:border-luxury-gold hover:border-gray-400'
                      }`}
                ...
                <div className="flex flex-col sm:flex-row gap-4 sm:gap-6 pt-2 sm:pt-4">
                  <button
                    ...
                    className="flex-1 bg-black text-white py-3 sm:py-4 px-6 sm:px-8 font-light hover:bg-gray-900 transition-colors text-sm sm:text-base flex items-center justify-center gap-3 disabled:bg-gray-300 disabled:cursor-not-allowed font-futura-pt-light"
                  >
                    {isSubmitting ? (
                      <>
                  ...
                  <button
                    ...
                    className="flex-1 bg-black text-white font-light hover:bg-gray-900 transition-colors flex items-center justify-center gap-3 text-sm sm:text-base py-3 sm:py-4 px-6 sm:px-8 font-futura-pt-light"
                  >
